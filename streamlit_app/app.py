...
def create_pdf_report(pred_labels, accuracy, confidence, time_axis, y_ai, name, duration_hours, sampling_rate=100):
    ...
    pdf.set_font("helvetica", "", 12)
    pdf.cell(0, 8, safe_text(f"Dominant Stage: {pd.Series(pred_labels).mode()[0]}"), ln=True)
    ...
    pdf.multi_cell(0, 5, safe_text("Automatically generated by NeuroSleep AI - For research support only - Not a medical diagnosis"), align="C")
    ...
    pdf.set_font("helvetica", "", 12)
    for c in comments:
        pdf.multi_cell(0, 8, safe_text(f"- {c}"))
